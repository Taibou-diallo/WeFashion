...
@section('contenu')
    <div class="my-3 p-3 bg-body rounded shadow-sm mt-4">
        <h3 class="border-bottom pb-2 mt-4">Bienvenue dans notre site</h3>
                    ...
                    <div class="product-grid9">
                        <div class="product-image9">
                            <a href="#">
                                ...
                                <img class="pic-1" width="171" src="{{ asset('image/' . $product->picture->link) }}"
                        ...
                        <div class="product-content">>
                            ...
                            <p class="add-to-cart"><a
                                    href="{{ url('fashion', $product->id) }}">{{ $product->name }}</a>
                            </p>
                        </div>
                    </div>
                </div>
